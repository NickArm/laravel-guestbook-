    ...
    <div class="container-fixed flex justify-between items-center lg:gap-4" id="header_container">
     ...
     <div class="flex items-center gap-2 lg:gap-5 2xl:-ml-[60px]">
      <a href="html/demo2.html">
       <img class="dark:hidden max-w-[40px] logo" src="assets/media/logos/welcomy-icon.jpg"/>
     ...
     <div class="flex items-center gap-3.5">
      <div class="flex items-center gap-1">
       <div class="dropdown" data-dropdown="true" data-dropdown-offset="115px, 10px" data-dropdown-offset-rtl="-115px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        <button class="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-gray-200 dropdown-open:bg-gray-200 text-gray-600">
            ...
            <div class="menu-dropdown menu-default w-full max-w-[175px]" data-menu-dismiss="true">
             ...
             <div class="menu-item" data-menu-item-offset="-15px, 0" data-menu-item-placement="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
              ...
              <div class="menu-dropdown menu-default w-full max-w-[175px]">
               <div class="menu-item">
                <a class="menu-link" href="html/demo2/account/home/settings-sidebar.html">
                 <span class="menu-icon">
       ...
       <div class="dropdown" data-dropdown="true" data-dropdown-offset="75px, 10px" data-dropdown-offset-rtl="-75px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        <button class="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-gray-200 dropdown-open:bg-gray-200 text-gray-600">
              ...
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
               ...
               <div class="menu-dropdown menu-default w-full max-w-[175px]" data-menu-dismiss="true">
                ...
                <div class="menu-item" data-menu-item-offset="-15px, 0" data-menu-item-placement="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                 ...
                 <div class="menu-dropdown menu-default w-full max-w-[175px]">
                  <div class="menu-item">
                   <a class="menu-link" href="html/demo2/account/members/import-members.html">
                    <span class="menu-icon">
                ...
                <div class="menu-item">
                 <a class="menu-link" href="html/demo2/account/security/privacy-settings.html">
                  <span class="menu-icon">
      ...
      <div class="menu" data-menu="true">
       <div class="menu-item" data-menu-item-offset="20px, 10px" data-menu-item-offset-rtl="-20px, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
        ...
        <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
          ...
          <div class="flex items-center gap-2">
           <img alt="" class="size-9 rounded-full border-2 border-success" src="assets/media/avatars/300-2.png">
            <div class="flex flex-col gap-1.5">
             ...
             <a class="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="html/demo2/account/home/get-started.html">
              c.fisher@gmail.com
             </a>
            </div>
           </img>
         ...
         <div class="flex flex-col">
          <div class="menu-item">
           <a class="menu-link" href="html/demo2/public-profile/profiles/default.html">
            <span class="menu-icon">
